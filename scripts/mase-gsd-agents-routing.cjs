...
const PACKAGE_IDENTITY = require('../get-shit-done/bin/lib/package-identity.cjs');

const START = '<!-- gsd-routing-start -->';
const END = '<!-- gsd-routing-end -->';
const TEMPLATE_VERSION = '2026-05-11.1';
...
function templateBody() {
  return [
    ...
    '',
    `Do not use \`/gsd-update\`, \`npx ${PACKAGE_IDENTITY.packageName}@latest\`, public npm update`,
