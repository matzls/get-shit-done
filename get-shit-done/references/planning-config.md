...
| `workflow.plan_review` | boolean | `true` | `true`, `false` | Run cross-AI plan review before execute-phase starts. Advisory only; existing `REVIEWS.md` artifacts are reused |
